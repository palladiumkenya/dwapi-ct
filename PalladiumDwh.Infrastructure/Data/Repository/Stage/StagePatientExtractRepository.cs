...
";
        ...
        public Task UpdateExisting(Guid manifestId, List<Guid> ids)
        {
            var sqlUpdates = @"
                    SELECT        
                         CurrentPatientId Id, Emr, Project, Voided, Processed, NUPI, PatientUUID, Pkv, Occupation, Gender, DOB, RegistrationDate, RegistrationAtCCC, RegistrationATPMTCT, RegistrationAtTBClinic, Region, PatientSource, District, Village, ContactRelation, LastVisit, 
