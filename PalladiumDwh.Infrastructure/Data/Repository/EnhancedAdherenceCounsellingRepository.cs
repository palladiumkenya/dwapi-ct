...
namespace PalladiumDwh.Infrastructure.Data.Repository
{
    ...
    public void ClearNew(Guid patientId)
      ...
      public void SyncNew(Guid patientId, IEnumerable<EnhancedAdherenceCounsellingExtract> extracts)
      {
        ...
        public void SyncNew(List<EnhancedAdherenceCounsellingProfile> profiles, IActionRegisterRepository actionRegisterRepository)
        {

            var extracts = new List<EnhancedAdherenceCounsellingExtract>();
            var action = "DELETE";
            var area = $"{nameof(EnhancedAdherenceCounsellingExtract)}";
            ...
            if (profiles.Any())
            {
                ...
                var sql = $@"  DELETE FROM {nameof(EnhancedAdherenceCounsellingExtract)} 
