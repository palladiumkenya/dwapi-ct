...
namespace PalladiumDwh.Infrastructure.Data.Repository
{
    ...
    public class GbvScreeningRepository : GenericRepository<GbvScreeningExtract>, IGbvScreeningRepository
    {
        private readonly DwapiCentralContext _context;
        public GbvScreeningRepository(DwapiCentralContext context) : base(context)
        {
            _context = context;
        }
        ...
        public void Sync(Guid patientId, IEnumerable<GbvScreeningExtract> extracts)
        {
            Clear(patientId);
            Insert(extracts);
            CommitChanges();
    ...
    public void ClearNew(Guid patientId)
      {
        string sql = "DELETE FROM GbvScreeningExtract WHERE PatientId = @PatientId";
        _context.GetConnection().Execute(sql, new { PatientId = patientId });
      }

      public void SyncNew(Guid patientId, IEnumerable<GbvScreeningExtract> extracts)
      {
        ClearNew(patientId);
