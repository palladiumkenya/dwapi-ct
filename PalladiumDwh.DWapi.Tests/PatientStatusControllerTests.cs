...
{
    [TestFixture]
    public class PatientStatusControllerTests
    {
        ...
        private PatientStatusController _controller;
        ...
        public void SetUp()
        {
            ...
            _controller = new PatientStatusController(_messagingService);
        ...
        {
            var profile = PatientStatusProfile.Create(_facility, _patientWithAllExtracts);
