...
{
    [TestFixture]
    public class PatientVisitsControllerTests
    {
        ...
        private PatientVisitsController _controller;
        ...
        public void SetUp()
        {
            ...
            _controller = new PatientVisitsController(_messagingService,new MessengerScheduler(),null);
            TestHelpers.SetupControllerForTests(_controller, baseUrl, "PatientVisits");
        ...
        {
            var profile = PatientVisitProfile.Create(_facility, _patientWithAllExtracts);
