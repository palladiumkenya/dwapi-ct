...
{
    [TestFixture]
    public class PatientPharmacyControllerTests
    {
        ...
        private PatientPharmacyController _controller;
        ...
        public void SetUp()
        {
            ...
            _controller = new PatientPharmacyController(_messagingService,new MessengerScheduler(),null);
            TestHelpers.SetupControllerForTests(_controller, baseUrl, "PatientPharmacy");
        ...
        {
            var profile = PatientPharmacyProfile.Create(_facility, _patientWithAllExtracts);
