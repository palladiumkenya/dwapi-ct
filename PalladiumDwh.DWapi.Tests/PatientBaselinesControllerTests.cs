...
{
    [TestFixture]
    public class PatientBaselinesControllerTests
    {
        ...
        private PatientBaselinesController _controller;
        ...
        public void SetUp()
        {
            ...
            _controller = new PatientBaselinesController(_messagingService,new MessengerScheduler(),null);
            TestHelpers.SetupControllerForTests(_controller, baseUrl, "PatientBaselines");
        ...
        {
            var profile = PatientBaselineProfile.Create(_facility, _patientWithAllExtracts);
