...
{
    [TestFixture]
    public class PatientAdverseEventsControllerTests
    {
        ...
        private PatientAdverseEventsController _controller;
        ...
        public void SetUp()
        {
            ...
            _controller = new PatientAdverseEventsController(_messagingService,new MessengerScheduler(),null);
            TestHelpers.SetupControllerForTests(_controller, baseUrl, "PatientAdverseEvents");
        ...
        {
            var profile = PatientAdverseEventProfile.Create(_facility, _patientWithAllExtracts);
