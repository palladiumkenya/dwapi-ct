...
{
    public class StageCancerScreeningExtract:StageExtract, IStageCancerScreeningExtract
    {
        ...
        public  void Standardize(CancerScreeningSourceBag sourceBag)
        {
            CheckId();
        ...
        public  void Standardize(CancerScreeningSourceBag sourceBag, List<FacilityCacheDto> facilityCacheDtos)
        {
            CheckId();
            LiveSession = sourceBag.ManifestId;
