...
namespace PalladiumDwh.Infrastructure.Tests
{
    ...
    public class PatientPharmacyRepositoryTests
    {
        ...
        public void should_Sync_With_Updated_Patients_Added()
        {
            ...
            _patientPharmacyRepository.SyncNewPatients(_visitProfiles, _facilityRepository);
            _context = new DwapiCentralContext();
        ...
        {
            _patientPharmacyRepository.SyncNewPatients(_newPharmacyProfiles, _facilityRepository);
            _context = new DwapiCentralContext();
        ...
        public void should_Sync_Patient_With_Updated_Pharmacys_Added()
        {
            ...
            _patientPharmacyRepository.SyncNewPatients(_updatedPharmacyProfiles, _facilityRepository);
            _context = new DwapiCentralContext();
