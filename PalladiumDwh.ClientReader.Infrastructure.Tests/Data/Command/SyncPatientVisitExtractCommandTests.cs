...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Data.Command
{
    public class SyncPatientVisitExtractCommandTests
    {
        ...
        public void SetUp()
        {
            ...
            _context.Database.ExecuteSqlCommand("DELETE FROM EventHistory;DELETE FROM PatientVisitExtract;DELETE FROM TempPatientVisitExtract;");
        ...
        public void should_sync_patients()
        {
            ...
            var extractCommand = new LoadPatientVisitExtractCommand(_emrRepository);
            var extracts = extractCommand.ExecuteAsync().Result;
            var validateCommand = new ValidatePatientVisitExtractCommand(_emrRepository, new ValidatorRepository(_context));
            var validations = validateCommand.ExecuteAsync().Result;

            var watch = System.Diagnostics.Stopwatch.StartNew();
            _syncCommand = new SyncPatientVisitExtractCommand(_emrRepository);
