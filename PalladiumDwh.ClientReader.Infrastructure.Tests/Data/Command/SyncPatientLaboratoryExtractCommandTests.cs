...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Data.Command
{
    public class SyncPatientLaboratoryExtractCommandTests
    {
        ...
        public void SetUp()
        {
            ...
            _context.Database.ExecuteSqlCommand("DELETE FROM EventHistory;DELETE FROM PatientLaboratoryExtract;DELETE FROM TempPatientLaboratoryExtract;");
        ...
        public void should_sync_patients()
        {
            ...
            var extractCommand = new LoadPatientLaboratoryExtractCommand(_emrRepository);
            var extracts = extractCommand.ExecuteAsync().Result;
            var validateCommand = new ValidatePatientLaboratoryExtractCommand(_emrRepository, new ValidatorRepository(_context));
            var validations = validateCommand.ExecuteAsync().Result;

            var watch = System.Diagnostics.Stopwatch.StartNew();
            _syncCommand = new SyncPatientLaboratoryExtractCommand(_emrRepository);
            ...
            var extractSettingId = emr.GetActiveExtractSetting("TempPatientLaboratoryExtract").Id;
