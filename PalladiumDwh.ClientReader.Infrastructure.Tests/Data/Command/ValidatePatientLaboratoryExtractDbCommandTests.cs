...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Data.Command
{
    ...
    public class ValidatePatientLaboratoryExtractDbCommandTests
    {
        ...
        public void SetUp()
        {
            ...
            _extractCommand = new ValidatePatientLaboratoryExtractCommand(_emrRepository, new ValidatorRepository(_context));
            _context.Database.ExecuteSqlCommand("DELETE FROM EventHistory;DELETE FROM TempPatientLaboratoryExtract;DELETE FROM ValidationError");
        }
        ...
        public void should_Execute_Validate_PatientLaboratoryExtract_DbCommand()
        {
            ...
            var result = new LoadPatientLaboratoryExtractCommand(_emrRepository).ExecuteAsync().Result;
