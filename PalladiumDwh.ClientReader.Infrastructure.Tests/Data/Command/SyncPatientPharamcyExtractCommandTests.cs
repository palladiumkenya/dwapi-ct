...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Data.Command
{
    public class SyncPatientPharamcyExtractCommandTests
    {
        ...
        public void SetUp()
        {
            ...
            _context.Database.ExecuteSqlCommand("DELETE FROM EventHistory;DELETE FROM PatientPharmacyExtract;DELETE FROM TempPatientPharmacyExtract;");
        ...
        public void should_sync_patients()
        {
            ...
            var extractCommand = new LoadPatientPharmacyExtractCommand(_emrRepository);
            var extracts = extractCommand.ExecuteAsync().Result;
            var validateCommand = new ValidatePatientPharmacyExtractCommand(_emrRepository, new ValidatorRepository(_context));
            var validations = validateCommand.ExecuteAsync().Result;

            var watch = System.Diagnostics.Stopwatch.StartNew();
            _syncCommand = new SyncPatientPharmacyExtractCommand(_emrRepository);
            ...
            var extractSettingId = emr.GetActiveExtractSetting("TempPatientPharmacyExtract").Id;
