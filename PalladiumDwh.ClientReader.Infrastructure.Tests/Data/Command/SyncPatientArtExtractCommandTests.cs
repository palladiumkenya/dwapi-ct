...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Data.Command
{
    public class SyncPatientArtExtractCommandTests
    {
        ...
        public void SetUp()
        {
            ...
            _context.Database.ExecuteSqlCommand("DELETE FROM EventHistory;DELETE FROM PatientArtExtract;DELETE FROM TempPatientArtExtract;");
        ...
        public void should_sync_patients()
        {
            ...
            var extractCommand = new LoadPatientArtExtractCommand(_emrRepository);
            var extracts = extractCommand.ExecuteAsync().Result;
            var validateCommand = new ValidatePatientArtExtractCommand(_emrRepository, new ValidatorRepository(_context));
            var validations = validateCommand.ExecuteAsync().Result;
            
            var watch = System.Diagnostics.Stopwatch.StartNew();
            _syncCommand = new SyncPatientArtExtractCommand(_emrRepository);
