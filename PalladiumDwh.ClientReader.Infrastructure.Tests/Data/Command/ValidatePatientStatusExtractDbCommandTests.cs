...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Data.Command
{
    public class ValidatePatientStatusExtractDbCommandTests
    {
        ...
        public void SetUp()
        {
            ...
            _extractCommand = new ValidatePatientStatusExtractCommand(_emrRepository, new ValidatorRepository(_context));
            _context.Database.ExecuteSqlCommand("DELETE FROM EventHistory;DELETE FROM TempPatientStatusExtract;DELETE FROM ValidationError");
        }
        ...
        public void should_Execute_Validate_PatientStatusExtract_DbCommand()
        {
            ...
            var result = new LoadPatientStatusExtractCommand(_emrRepository).ExecuteAsync().Result;
