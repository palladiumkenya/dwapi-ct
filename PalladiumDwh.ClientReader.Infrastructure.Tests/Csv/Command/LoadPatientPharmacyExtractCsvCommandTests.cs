...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Csv.Command
{
    public class LoadPatientPharmacyExtractCsvCommandTests
    {
        ...
        private ILoadPatientPharmacyExtractCsvCommand _extractCommand;
        private int top = 5;
        ...
        public void SetUp()
        {
            ...
            _commandText = TestHelpers.GetCsv("PatientPharmacyExtract", "Extracts");

            _extractCommand = new LoadPatientPharmacyExtractCsvCommand(_emrRepository);
