...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Csv.Command
{
    public class LoadPatientExtractCsvCommandTests
    {
        ...
        private ILoadPatientExtractCsvCommand _extractCommand;
        private int top = 5;
        ...
        public void SetUp()
        {
            ...
            _commandText = TestHelpers.GetCsv("_PatientExtract");
            _extractCommand = new LoadPatientExtractCsvCommand(new EMRRepository(_context));
