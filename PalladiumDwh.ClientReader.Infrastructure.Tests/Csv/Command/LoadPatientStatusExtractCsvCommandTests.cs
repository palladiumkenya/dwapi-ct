...
namespace PalladiumDwh.ClientReader.Infrastructure.Tests.Csv.Command
{
    public class LoadPatientStatusExtractCsvCommandTests
    {
        ...
        private ILoadPatientStatusExtractCsvCommand _extractCommand;
        private int top = 5;
        ...
        public void SetUp()
        {
            ...
            _commandText = TestHelpers.GetCsv("PatientStatusExtract", "Extracts");

            _extractCommand = new LoadPatientStatusExtractCsvCommand(_emrRepository);
