...
namespace PalladiumDwh.DWapi.Controllers
{
    public class IptController : ApiController
    {
        ...
        public IptController(IMessagingSenderService messagingService,IMessengerScheduler messengerScheduler)
        {
        ...
        [Route("api/v3/Ipt")]
        public async Task<HttpResponseMessage> PostBatch([FromBody] IptSourceBag sourceBag)
        {
