...
namespace PalladiumDwh.DWapi.Controllers
{
    public class PatientBaselinesController : ApiController
    {
        ...
        public PatientBaselinesController(IMessagingSenderService messagingService,IMessengerScheduler messengerScheduler, IMediator mediator)
        {
        ...
        public async Task<HttpResponseMessage> PostBatchNew([FromBody] BaselineSourceBag sourceBag)
        {
