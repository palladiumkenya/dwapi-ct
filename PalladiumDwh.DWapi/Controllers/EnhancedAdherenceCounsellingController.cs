...
{
    public class EnhancedAdherenceCounsellingController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> PostBatch([FromBody] EnhancedAdherenceCounsellingSourceBag sourceBag)
        {
